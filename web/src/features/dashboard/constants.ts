...
export const SECTION_READINESS_ITEMS: Array<{
  ...
  { key: "defiTvl", label: "DeFi TVL", shortLabel: "TVL" },
  { key: "dexVolume", label: "DEX Volume", shortLabel: "DEX" },
...
export const DASHBOARD_VIEWS: Array<{
  ...
  { key: "onchain", label: "On Chain", hint: "Supply + TVL + DEX volume" },
...
export const SECTION_STAGE_MAP: Record<RunReviewSectionKey, RunReviewStageKey[]> = {
  ...
  defiTvl: ["fetch_market_macro"],
  dexVolume: ["fetch_market_macro"],
